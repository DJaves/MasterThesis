...
global outcomes `" "violenze sessuali" "totale" "furti" "'
...
use final_database, clear
	...
	foreach outcome in $outcomes {
			* RDD - No Controls - 20% margin threshold
				...
				eststo rob1_1: rdrobust totale_pc_x100000 margin_fem if delitto_name=="violenze sessuali", covs(elettori frac_female) masspoints(adjust)
	...
	foreach outcome in $outcomes {
		* RDD - No Controls - 20% margin threshold
		foreach n in 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 {
			...
			esttab reg1_1_2004 reg1_1_2005 reg1_1_2006 reg1_1_2007 reg1_1_2008 reg1_1_2009 reg1_1_2010 reg1_1_2011 reg1_1_2012 reg1_1_2013 using "$output/Het_`outcome'_Year_1.tex", stats(N r2) star(* 0.10 ** 0.05 *** 0.01) mtitles("2004" "2005" "2006" "2007" "2008" "2009" "2010" "2011" "2012" "2013") title("`outcome', by year") replace se
		...
		* RDD - Year FE - 20% margin threshold
		foreach n in 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 {
			...
			esttab reg1_1_2004 reg1_1_2005 reg1_1_2006 reg1_1_2007 reg1_1_2008 reg1_1_2009 reg1_1_2010 reg1_1_2011 reg1_1_2012 reg1_1_2013 using "$output/Het_`outcome'_Year_2.tex", stats(N r2) star(* 0.10 ** 0.05 *** 0.01) mtitles("2004" "2005" "2006" "2007" "2008" "2009" "2010" "2011" "2012" "2013") title("`outcome', by year") replace se
		...
		*RDD - Year FE, number of electors - 20% margin threshold
			...
			esttab reg1_1_2004 reg1_1_2005 reg1_1_2006 reg1_1_2007 reg1_1_2008 reg1_1_2009 reg1_1_2010 reg1_1_2011 reg1_1_2012 reg1_1_2013 using "$output/Het_`outcome'_Year_3.tex", stats(N r2) star(* 0.10 ** 0.05 *** 0.01) mtitles("2004" "2005" "2006" "2007" "2008" "2009" "2010" "2011" "2012" "2013") title("`outcome', by year") replace se
		...
		*RDD - Year FE, number of electors, female fraction - 20% margin threshold
		foreach n in 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013{
			...
			esttab reg1_1_2004 reg1_1_2005 reg1_1_2006 reg1_1_2007 reg1_1_2008 reg1_1_2009 reg1_1_2010 reg1_1_2011 reg1_1_2012 reg1_1_2013 using "$output/Het_`outcome'_Year_4.tex", stats(N r2) star(* 0.10 ** 0.05 *** 0.01) mtitles("2004" "2005" "2006" "2007" "2008" "2009" "2010" "2011" "2012" "2013") title("`outcome', by year") replace se
